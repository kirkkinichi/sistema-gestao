<x-layout>
    <div class="flex justify-center items-center min-h-screen bg-gray-100">
        <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
            <h1 class="text-3xl font-semibold text-center text-gray-800 mb-6">Cadastrar Bandeira</h1>
            ...
            <form method="POST" action="/bandeira">
                ...
                @else
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="nome" name="nome" class="mt-1 block w-full p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-[#ffb800]" required>
                    </div>
